...
* ⚙️ Gameplay rules and server parameters
* 🌐 Data used by mods and server-side scripts

> ⚠️ All files stored here are **server-side only** and are not intended to be modified by clients.
...
* Update moderation and ban systems in real time
